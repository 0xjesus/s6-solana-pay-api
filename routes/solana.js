...
router.post('/mint-compressed-nfts', SolanaController.mintCompressedNFTs);
...
router.post('/verify-collection', SolanaController.verifyCollection);
router.post('/verify-collection-new', SolanaController.verifyCollectionNewFunction);
export  {router};
